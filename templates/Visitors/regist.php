                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <?php elseif ($type === "teacher") : ?>
                            ...
                            <div class="card-body">
                                <p class="card-text">以下の質問に回答し、あてはまるものにチェックをつけてください。あなたが教職員でない場合は <a href="http://localhost/covid19/">こちら</a> から前のページにお戻りください。</p>
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    ...
                    <button type="button" onclick="location.href='../select'" class="btn btn-primary btn-block mt-3">はじめのページににもどる<br>Back to Top page.</button>
                </div>
            </div>
        </div>
    <?php endif; ?>
